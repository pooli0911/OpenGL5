// 
// Example 3 : Alpha Blending 運作原理展示
// 
...
void init(void)
{
	...
	g_pCube->setKaKdKsShini(0, 0.8f, 0.2f, 2);
	...
	g_pAimal[0]->setKaKdKsShini(0, 0.8f, 0.2f, 1);
	...
	g_pAimal[1]->setKaKdKsShini(0, 0.8f, 0.2f, 1);
	...
	g_pAimal[2]->setKaKdKsShini(0, 0.8f, 0.2f, 1);
...
int main( int argc, char **argv )
{
    ...
    glutCreateWindow("Example 3 : Alpha Blending");
